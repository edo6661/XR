...
export const XRAS_KL_SPEAKERS: readonly XrasSpeaker[] = [
  ...
  {
    name: "Prof Ts Dr Siti Azreena Mubin",
    role: "Assistant Professor/XR Studio Lead",
    company:
      "Asia Pacific University of Technology and Innovation (APU / APIIT)",
    photo: "/speaker-pics/Siti Azreena.jpg.jpeg",
    accentColor: "#3953a3",
    focusAreas: ["XR Education", "Studio Production", "Immersive Media"],
  },
  {
    name: "Robert Majoch",
