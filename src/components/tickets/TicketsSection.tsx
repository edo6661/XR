      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              Where Asia Builds Its Spatial Future. Whether you're attending, exhibiting, sponsoring, or speaking, XR Summits connects you to the conversations and partnerships that matter.
            </motion.p>
