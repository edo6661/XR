...
const FooterLink = ({ label, to }: { label: string; to: string }) => (
  <li>
    <Link
      ...
      style={{ color: 'rgba(107,127,163,0.65)', fontSize: '0.78rem' }}
    >
      {label}
    </Link>
  </li>
...
const Footer = () => {
  return (
    <footer
      ...
      style={{ background: 'rgba(3,6,12,0.98)' }}
    >
      {/* Top accent line */}
      <div
        className="absolute top-0 left-0 right-0 h-px"
        style={{
          background: 'linear-gradient(90deg, transparent, rgba(251,146,60,0.35) 30%, rgba(251,146,60,0.35) 70%, transparent)',
        }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse, rgba(251,146,60,0.03) 0%, transparent 68%)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pt-16 pb-14">
          ...
          {/* Brand col — takes 4 of 12 */}
          <div className="md:col-span-4 flex flex-col gap-6">
            {/* Logo */}
            <Link to="/" className="group flex items-center gap-3 w-fit select-none">
              <div className="relative w-9 h-9">
                <div
                  className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-400 blur-sm"
              ...
              <div className="flex flex-col leading-none">
                <span
                  className="font-heading font-bold tracking-[0.28em] text-foreground group-hover:text-accent transition-colors duration-300"
                  style={{ fontSize: '0.78rem' }}
                >
                  XR SUMMITS
                </span>
                <span
                  className="font-heading font-light tracking-[0.45em] uppercase"
                  style={{ fontSize: '0.45rem', marginTop: '2px', color: 'rgba(107,127,163,0.55)' }}
                >
                  Asia · Est. 2021
                </span>
              </div>
            ...
            {/* Tagline */}
            <p style={{ fontSize: '0.8rem', color: 'rgba(107,127,163,0.7)', lineHeight: 1.75, maxWidth: '280px' }}>
              ...
              {SOCIALS.map(({ label, href, icon }) => (
                <motion.a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    el.style.color = 'rgba(251,146,60,0.8)';
                    el.style.background = 'rgba(251,146,60,0.08)';
                  }}
                  onMouseLeave={(e) => {
                    const el = e.currentTarget as HTMLAnchorElement;
                    el.style.borderColor = 'rgba(255,255,255,0.07)';
                    el.style.color = 'rgba(107,127,163,0.55)';
            ...
            <address
              ...
              style={{ fontSize: '0.72rem', color: 'rgba(107,127,163,0.5)', lineHeight: 1.7 }}
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
          <p style={{ fontSize: '0.68rem', color: 'rgba(107,127,163,0.4)' }}>
          ...
          <a
            ...
            style={{ fontSize: '0.68rem', color: 'rgba(107,127,163,0.4)' }}
            onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = 'rgba(251,146,60,0.7)'; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = 'rgba(107,127,163,0.4)'; }}
          >
            hello@xrsummits.com
          </a>
          ...
          <button
            ...
            style={{ color: 'rgba(107,127,163,0.4)', fontSize: '0.68rem' }}
            onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.color = 'rgba(251,146,60,0.7)'; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.color = 'rgba(107,127,163,0.4)'; }}
            aria-label="Back to top"
          >
            <span className="font-bold tracking-[0.22em] uppercase">Back to top</span>
            <motion.span
              animate={{ y: [0, -3, 0] }}
